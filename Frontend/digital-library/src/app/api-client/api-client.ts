...
export class ApiClient {
     ...
     * @return OK
     */
    chooseCategoryAll(): Observable<UserSelectedCategory[]> {
        let url_ = this.baseUrl + "/api/member/ChooseCategory";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processChooseCategoryAll(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processChooseCategoryAll(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<UserSelectedCategory[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<UserSelectedCategory[]>;
        }));
    }

    protected processChooseCategoryAll(response: HttpResponseBase): Observable<UserSelectedCategory[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(UserSelectedCategory.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return OK
     */
    chooseCategory(body: UserSelectedCategory[]): Observable<void> {
        let url_ = this.baseUrl + "/api/member/ChooseCategory";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processChooseCategory(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processChooseCategory(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processChooseCategory(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<UserForAdminModel[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<UserForAdminModel[]>;
        }));
    }

    protected processUser(response: HttpResponseBase): Observable<UserForAdminModel[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(UserForAdminModel.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    usersToCategoryAll(): Observable<UsersToCategoryModel[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUsersToCategoryAll(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUsersToCategoryAll(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<UsersToCategoryModel[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<UsersToCategoryModel[]>;
        }));
    }

    protected processUsersToCategoryAll(response: HttpResponseBase): Observable<UsersToCategoryModel[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(UsersToCategoryModel.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    usersToCategory(body?: UsersToCategoryModel | undefined): Observable<void> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUsersToCategory(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUsersToCategory(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processUsersToCategory(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class UserForAdminModel implements IUserForAdminModel {
    userId!: string;
    name!: string;

    constructor(data?: IUserForAdminModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UserForAdminModel {
        data = typeof data === 'object' ? data : {};
        let result = new UserForAdminModel();
        result.init(data);
        return result;
    }
...
export class UserSelectedCategory implements IUserSelectedCategory {
    userId!: string;
    category!: Category;
    isSelected!: boolean;

    constructor(data?: IUserSelectedCategory) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UserSelectedCategory {
        data = typeof data === 'object' ? data : {};
        let result = new UserSelectedCategory();
        result.init(data);
        return result;
    }
...
export interface IUserSelectedCategory {
    userId: string;
    category: Category;
    isSelected: boolean;
}

export class UsersToCategoryModel implements IUsersToCategoryModel {
    categoryId!: number;
    categoryTitle!: string;
    users!: UserForAdminModel[];

    constructor(data?: IUsersToCategoryModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["users"])) {
                ...
                for (let item of _data["users"])
                    this.users!.push(UserForAdminModel.fromJS(item));
            }
        }
    }

    static fromJS(data: any): UsersToCategoryModel {
        data = typeof data === 'object' ? data : {};
        let result = new UsersToCategoryModel();
        result.init(data);
        return result;
    }
...
export interface IUsersToCategoryModel {
    categoryId: number;
    categoryTitle: string;
    users: UserForAdminModel[];
}
